    	 ...
    	 if($arrayAuthenticated['authenticated']){
	        ...
	        try {
			        ...
			        if (Upload::is_valid())
			        {
			            ...
			            {
			            	$photoToSave = 'http://' . $_SERVER['SERVER_NAME'] . ':' . $_SERVER['SERVER_PORT'] . '/API4/fuelphp/public/assets/img/'
			            	. $file['saved_as'];
			            }
			        }
		         ...
		         //FALTA AQUI GUARDAR LOS CAMBIOS DEL PICTURE PROFILE DEL USER. Y EL MENSAJE 200
	            	$photoToSave = $user->profilePicture;
			        return $this->respuesta(200, 'Foto guardada correctamente','');
